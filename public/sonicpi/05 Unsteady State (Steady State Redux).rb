  ...
  with_random_seed 0 do
    with_synth :fm do
      with_bpm 180 do
        ...
        270.times do
          tick
          (play_note notes1.look, 0.99, true, false) if beats1.look
          (play_note notes2.look, 0.99, false, false) if beats2.look
          (play_note notes3.look, 0.99, false, false) if beats3.look
          (play_note notes4.look, 0.99, true, false) if beats4.look
          sleep 1
        end
      ensure
        midi_all_notes_off
